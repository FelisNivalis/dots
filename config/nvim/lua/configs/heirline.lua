...
return function ()
    ...
    local function FileNameComp(func, thres)
        return {
            condition = function(self)
                if thres ~= nil then
                    return conditions.width_percent_below(#func(self), thres)
                else
                    return true
                end
            end,
            provider = function(self)
                return func(self) or "[No Name]"
            end
        }
    end
    local FileName = {
        {
            ...
            {
                flexible = Flexible.WorkDir,
                FileNameComp(function(self)
                    return self.cwd .. '  '
                end, 0.1),
                FileNameComp(function(self)
                    return vim.fn.pathshorten(self.cwd, 2) .. '  '
                end, 0.1),
                FileNameComp(function(self)
                    return vim.fn.pathshorten(self.cwd, 1) .. '  '
                end, 0.1),
                { provider = '' },
            },
            hl = function(self)
        ...
        {
            flexible = Flexible.Filename, -- TODO: fix
            FileNameComp(function(self)
