{
  ...
  inputs = {
    ...
    # flakes
    superfile = { url = "github:MHNightCat/superfile/v1.1.3"; inputs.nixpkgs.follows = "nixpkgs"; };
    mise = { url = "github:jdx/mise/v2024.6.6"; inputs.nixpkgs.follows = "nixpkgs"; };
    ...
    neovim-src = { url = "github:neovim/neovim/v0.10.0"; flake = false; };
    micromamba = { url = "github:mamba-org/mamba/micromamba-1.5.8"; flake = false; };
    starship = { url = "github:starship/starship/v1.19.0"; flake = false; };
        ...
        modules = [
          ...
          ./packages.nix
          {
            home.packages = with inputs; [
              ...
              (overrideSrc pkgs.neovim.unwrapped neovim-src)
            ];
          }
